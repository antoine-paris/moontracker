...
export default function HelpTab() {
  return (
    <article itemScope itemType="https://schema.org/SoftwareApplication" className="prose-info">
      ...
      <p>
        La scène se recentre sur une cible: Soleil, Lune, Mercure à Neptune, ou un azimut cardinal. Idéal pour verrouiller une composition pendant un lever/coucher
      ...
      <h2>4) Vue principale — cadrage photo et navigation</h2>
      ...
      <h3><I id="arrow" />Pavé directionnel (cadrage fin)</h3>
      <p>
        Les flèches déplacent finement l’azimut et l’altitude autour de la référence (suivi). Le bouton <I id="center" /> recentre (az=0°, alt=0° relatifs).
        Les pas sont proportionnels au FOV pour une sensation constante. L’altitude est limitée pour éviter les singularités proches des pôles.
      </p>
      ...
      <h3><I id="capture" />Export PNG (presse‑papier + fichier)</h3>
      <p>Copie l’image et télécharge le PNG. L’option est désactivée lorsque l’interface est visible: basculez l’UI pour une capture «propre» du ciel. [CAPTURE]</p>
