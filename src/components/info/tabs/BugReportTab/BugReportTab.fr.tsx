export default function BugReportTabFr() {
  return (
    <article>
      ...
      <ol>
        <li>
          Ouvrir un ticket: <a href="https://github.com/antoine-paris/spaceview/issues" target="_blank" rel="noopener noreferrer">Nouvelle issue GitHub</a>.
        </li>
        <li>
